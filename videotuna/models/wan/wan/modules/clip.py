...
class CLIPModel:
    ...
    def __init__(
        self, dtype, device, checkpoint_path, tokenizer_path, model: XLMRobertaCLIP
    ):
        self.dtype = dtype
        self.device = device
        ...
        self.transforms = clip_transforms(
            model, "open-clip-xlm-roberta-large-vit-huge-14"
        )
    ...
    def load_weight(self):
        ...
        logger.info(
            f"loading CLIPModel weight from ckpt_path: {self.checkpoint_path} finished"
        )
