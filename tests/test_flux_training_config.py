...
FLUX_DATA = REPO_ROOT / "configs" / "006_flux" / "multidatabackend.json"
...
def test_flux_training_config_json_loads():
    ...
    assert config["--data_backend_config"] == "configs/006_flux/multidatabackend.json"
...
def test_flux_training_config_loader():
    ...
    assert train_cfg.max_train_steps == 12000
